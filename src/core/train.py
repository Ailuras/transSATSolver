...
from src.dataset.sat_dataset import SATDataset, CustomTokenizer
from src.core.trainer import SATHFTrainer
from src.utils.utils import get_dataset_path
...
block_size = 800
max_id = 30
out_dir = 'results/models/sat-gpt'
dataset = None
debug = False
